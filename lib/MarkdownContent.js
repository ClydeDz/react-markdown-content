...
function MarkdownContent(props) {
    ...
    return (react_1.default.createElement("div", { "data-testid": "MARKDOWN_CONTENT_CONTAINER", className: MarkdownContentUtils_1.resolveClassNames(className) }, react_html_parser_1.default(appState)));
}
